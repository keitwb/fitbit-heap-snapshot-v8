...
// This is used to map the JerryScript-1 node types to the output snapshot.  This makes the Chrome
// DevTools viewer show summary statistics but otherwise seems to just be cosmetic.
export const normalizedNodeTypes = new Map<t.TypeOf<typeof NodeTypes>, string>([
  ['Hidden', 'hidden'],
  ['Array', 'array'],
  ['String', 'string'],
  ['Object', 'object'],
...
export interface ChromeDevSnapshot {
  snapshot: {
    meta: {
      node_fields: string[],
